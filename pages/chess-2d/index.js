        ...
        <div className="form-container">
          <div className='content-container'>
            ...
            <div style={{ flex: 1, marginTop: 10 }}>
              ...
              <a href='https://ftmscan.com/address/0x46350eda48b3aafc4c403ff02c024e76ae22e803' className='mr-10' target='_blank' rel="noreferrer">
                <Image src='/assets/fantom.svg' alt='ftmscan' width='20' height='20' />
              </a>

              <a href='https://paintswap.finance/marketplace/collections/0x46350eda48b3aafc4c403ff02c024e76ae22e803' className='mr-10' target='_blank' rel="noreferrer">
                <Image src='/assets/paint.png' alt='paintswap' width='20' height='20' />
              </a>

              <a href='https://nftkey.app/collections/fantomchess/' target='_blank' rel="noreferrer">
          ...
          <div style={{ display: 'flex', justifyContent: 'center', marginTop: 20 }}>
            <a className='button' style={{ marginRight: 10 }} href="https://paintswap.finance/marketplace/collections/0x46350eda48b3aafc4c403ff02c024e76ae22e803" target='_blank' rel="noreferrer"> Paint Swap</a>
            <a className='button' href="https://nftkey.app/collections/fantomchess/" target='_blank' rel="noreferrer">NFTKEY</a>
          </div>
