        ...
        <Fragment>
            ...
            <div id="app" style={{ overflowY: 'auto' }}>
                ...
                <div className="form-container" style={{ width: '82vw', maxHeight: '70vh', overflowY: 'scroll', marginTop: 0 }}>
                    ...
                    <a style={{ marginLeft: 'auto', marginRight: 'auto', width: 250 }} href='https://lichess.org/tournament/do3rs0xT' target="_blank" className='button' rel="noreferrer">Sign up for FREE</a>
                </div>
            </div>
        </Fragment>
  )
