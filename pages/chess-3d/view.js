      ...
      <div id="app" style={{ height: '100vh' }}>
        <div className="form-container" style={{ width: '82vw', maxHeight: '70vh', overflowY: 'scroll' }}>
          <div style={{ display: 'flex', flexWrap: 'wrap', flexDirection: 'row' }}>
            ...
            {!loading && games.length == 0 && <div>You don't have a Fantom Chess 3D</div>}
            ...
            {games.map(game => {
              return (
                <div style={{ padding: 20, width: 300 }}>
                  ...
                  <br></br>
                  <video width='200' muted height='200' autoPlay={true} loop poster={'https://www.fantomchess.com/assets/' + game.id + '.mp4'} controls>
                    <source src={'https://www.fantomchess.com/assets/' + game.id + '.mp4'} type="video/mp4"></source>
                  </video>
