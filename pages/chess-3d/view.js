            ...
            {games.map(game => {
              return (
                <div style={{ padding: 20, width: 300 }}>
                  ...
                  <br></br>
                  <video width='200' muted height='200' autoPlay={true} loop poster={game.image.replace('ipfs://', 'https://dweb.link/ipfs/')} controls>
                    <source src={game.image.replace('ipfs://', 'https://dweb.link/ipfs/')} type="video/mp4"></source>
                  </video>
