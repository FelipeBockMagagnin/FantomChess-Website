...
contract FantomChess is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    uint256 public maxMintable = 444;
    string private _baseUrl;
    string public baseExtension = ".json";
    bool public pause = false;

    constructor(string memory baseUrl) ERC721("FantomChess3D", "CHESS3D") {
        _baseUrl = baseUrl;
    }
    ...
    function chessOwned(address _owner) external view returns (uint256[] memory) {
